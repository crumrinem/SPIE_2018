...
Precise measurements of the Cosmic Microwave Background have significantly
increased our understanding of the early universe. The discovery of the CMB
provided the first evidence for a Big Bang origin to the universe. Since then
the development of the $\Lambda$CDM cosmological model has seen tremendous
success in its ability to accurately and self-consistently explain and predict
experimental data. The $\Lambda$CDM model is however, still incomplete and
fails to explain the homogeneity and isotropy of our observable universe.
These issues can be resolved by an extension to the model in which the
universe undergoes exponential expansion known as Inflation just after the
initial big bang. Various models of inflation exist, many of which predict
that such an event would have generated a gravitational wave background.
Interaction between these Inflationary Gravitational Waves (IGWs) and the CMB
would have produced a characteristic gradient-free polarization signal
colloquially referred to as 'B-mode' signal. Measurement of this signal is
...
\begin{figure}[h]
	...
	\caption{A graphical representation of the \bk \ experiments from \bicep2
