...
\affil[k]{Service des Basses Temp\'{e}ratures, Commissariat \'{a} l’Energie Atomique, 38054 Grenoble, France}
...
universe\cite{penzias1965,dicke1965}---experimental cosmology has become an extremely active subfield of physics.
...
and predict observational data. The $\Lambda$CDM model is, however, still
...
the universe undergoes a period of exponential expansion known as inflation just after the beginning\cite{guth1981}. Various models of inflation exist, many of which predict that
such an event would have generated an observable gravitational wave background.
Interaction between these inflationary gravitational waves (IGWs) and the primordial plasma
would have produced a characteristic curl-like polarization signal
...
\begin{figure}[h]
	...
	\bicep2\ through \biceparray. The middle and bottom rows show the increased focal plane size and density of the \bicep3 style receivers as compared to \bicep2\ /\keck\ style. Different
...
sensitivity. A graphical progression from \bicep2\ to \biceparray\ is shown
...
\keckarray\ consists of five \bicep2 style receivers\cite{ogburn2010,sheehy2010} with observations spread
across four frequency bands (95, 150, 220, and 270 GHz). The combination of
 \bicep2 and \keckarray\ data has produced the tightest constraint on
this signal to date of $r<0.07$ ($95\%$ confidence)\cite{bk_vi}. \biceparray\ will build on the success
of the \keckarray\ by deploying four \bicep3 style receivers\cite{ahmed2014}, and expanding
...
\begin{figure} [hb]
	...
	width of the cryostat compared to \bicep3 in order to include adequate optical baffling at the
	lowest frequencies.}
	\label{fig:bavskeck}
\end{figure}
...
\begin{figure}[t]
\center
\includegraphics{heatstraps.png}
...
\bk\ series of experiments, including the \bicep1 team.
...
% References
\bibliography{cmb,misc,bicepkeck}
