...
The BICEP array cryostats continue to use the successful design philosophy of
the previous Bicep / Keck cryostats. A large vacuum shell contains two nested
radiation shields with nominal operating temperatures of 50K and 4K contained
within a large vacuum shell. The two radiation shields are cooled by the first
and second stages respectively of a Cryomech PT415-RM Pulse Tube cooler. This
cryocooler is capable of maintaining a second stage temperature of 4K under a
1.5W load. 



 Modeled after
the Bicep3 receivers, Bicep array maintains the 55cm aperture but adds
additional width in the 4K shell for optical baffling at the lower frequencies.
This additional room increases the diameter of the cryostat to 34.57" as
compared to Bicep3's 28.7".
