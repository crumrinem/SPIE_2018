...
initial Big Bang\cite{guth1981}. Various models of inflation exist, many of which predict that
...
across four frequency bands (95, 150, 220, and 270 GHz). The combination of
 \bicep2 and \keckarray\ data has produced the strictest constraint on
...
\begin{figure} [hb]
	...
	width of the cryostat compared to \bicep3 in order to include more optical baffling at the
	lowest frequencies.}
	\label{fig:bavskeck}
\end{figure}
...
\clearpage
% References
\bibliography{cmb,misc,bicepkeck} % bibliography data in report.bib
